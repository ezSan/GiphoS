...
const likeBtn = (cajitaTools, imgId) => {
    ...
    favAdd.addEventListener('click', function () {
        ...
        if (favAdd.classList.contains('inactive')) {
            let favTitle = this.parentNode.parentElement.childNodes[0].childNodes[0].innerText;
            let favAuthor = this.parentNode.parentElement.childNodes[0].childNodes[1].innerText;
